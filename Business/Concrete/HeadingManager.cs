...
namespace Business.Concrete
{
    public class HeadingManager : IHeadingService
    {
        ...
        public List<Heading> GetAllHeadingByWriter(int id)
        {
            return _headingDal.GetAll(h => h.WriterId == id && h.Statu==true);
        }

        public string NumberOfHeading()
        {
            return _headingDal.GetAll().Count().ToString();
        }
    }
}
